...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.image.style1', { style: 'zoom-in', speed: 750, intensity: 10, delay: 0, state: true, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-up', speed: 750, intensity: 0, delay: 0, state: true, replay: false });
